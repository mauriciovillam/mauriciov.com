...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _spectacle_spectacle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./spectacle/spectacle */ "./src/assets/scripts/spectacle/spectacle.ts");
/* harmony import */ var _spectacle_scenarios_celestial_scenario__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./spectacle/scenarios/celestial-scenario */ "./src/assets/scripts/spectacle/scenarios/celestial-scenario.ts");


var spectacle = new _spectacle_spectacle__WEBPACK_IMPORTED_MODULE_0__["default"]([
    new _spectacle_scenarios_celestial_scenario__WEBPACK_IMPORTED_MODULE_1__["default"],
]);
spectacle.start();
...
/***/ "./src/assets/scripts/spectacle/element.ts":
/*!*************************************************!*\
  !*** ./src/assets/scripts/spectacle/element.ts ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var ScenarioElement = /** @class */ (function () {
    function ScenarioElement(scenario, className, animation, style) {
     ...
     */
    ScenarioElement.prototype.draw = function () {
        var _a;
        var _this = this;
        this.domElement = document.createElement("div");
        (_a = this.domElement.classList).add.apply(_a, this.className.split(' '));
        Object.entries(this.style).forEach(function (_a) {
            var key = _a[0], value = _a[1];
            _this.domElement.style[key] = value;
        });
        this.scenario.spectacle.domElement.append(this.domElement);
    };
    return ScenarioElement;
}());
/* harmony default export */ __webpack_exports__["default"] = (ScenarioElement);


/***/ }),

/***/ "./src/assets/scripts/spectacle/scenarios/celestial-scenario.ts":
/*!**********************************************************************!*\
  !*** ./src/assets/scripts/spectacle/scenarios/celestial-scenario.ts ***!
  \**********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../element */ "./src/assets/scripts/spectacle/element.ts");
/* harmony import */ var animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! animejs/lib/anime.es */ "./node_modules/animejs/lib/anime.es.js");
...
var CelestialScenario = /** @class */ (function () {
    function CelestialScenario() {
        this.className = 'celestial';
    }
    CelestialScenario.prototype.draw = function () {
        var cloudAnimation = {
            translateX: {
        ...
        var parallaxAnimation = function (duration) {
            return { top: {
                    value: 0,
        ...
        this.elements = [
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--stars', cloudAnimation, {}),
            //new ScenarioElement(this, 'element--layer_11', parallaxAnimation, {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_10', parallaxAnimation(1), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_9', parallaxAnimation(1.2), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_8', parallaxAnimation(1.5), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_7', parallaxAnimation(1.7), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_6', parallaxAnimation(2.8), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_5', parallaxAnimation(2.3), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_4', parallaxAnimation(2.4), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_3', parallaxAnimation(2.55), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_2', parallaxAnimation(2.65), {}),
            new _element__WEBPACK_IMPORTED_MODULE_0__["default"](this, 'element--layer element--layer_1', parallaxAnimation(2.75), {})
        ];
    };
    CelestialScenario.prototype.play = function () {
        var _this = this;
        var index = 0;
        this.elements.forEach(function (element) {
            var configuration = element.animation;
            ...
            Object(animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_1__["default"])(configuration);
            index++;
        });
        ...
        setTimeout(function () {
            ...
            var parallaxInstance = new parallax_js__WEBPACK_IMPORTED_MODULE_2___default.a(_this.spectacle.domElement);
            parallaxInstance.friction(0.1, 0.1);
        }, 8000);
    };
    CelestialScenario.prototype.hide = function () {
    };
    return CelestialScenario;
}());
/* harmony default export */ __webpack_exports__["default"] = (CelestialScenario);


/***/ }),

/***/ "./src/assets/scripts/spectacle/spectacle.ts":
/*!***************************************************!*\
  !*** ./src/assets/scripts/spectacle/spectacle.ts ***!
  \***************************************************/
/*! exports provided: default */
...
var Spectacle = /** @class */ (function () {
    function Spectacle(scenarios) {
        var _this = this;
        this.scenarios = scenarios;
        this.scenarios.forEach(function (scenario) {
            scenario.spectacle = _this;
        });
     ...
     * Start the spectacle!
     */
    Spectacle.prototype.start = function () {
        var _this = this;
        var scenario = this.scenarios[0];
        var run = function (scenario, next) {
            if (_this.currentScenario) {
                _this.currentScenario.hide();
                _this.domElement.classList.remove("scenario--" + _this.currentScenario.className);
            }
            scenario.draw();
            _this.domElement.classList.add("scenario--" + scenario.className);
            scenario.play();
            _this.currentScenario = scenario;
            if (typeof _this.scenarios[next] !== 'undefined') {
                setTimeout(function () { return run(_this.scenarios[next], next + 1); }, 12000);
            }
        };
        run(scenario, 1);
    };
...
/* harmony default export */ __webpack_exports__["default"] = (Spectacle);
...
/***/ 0:
/*!**************************************************************************!*\
  !*** multi ./src/assets/scripts/index.ts ./src/assets/styles/index.scss ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/mauricio/projects/mauriciov/src/assets/scripts/index.ts */"./src/assets/scripts/index.ts");
module.exports = __webpack_require__(/*! /home/mauricio/projects/mauriciov/src/assets/styles/index.scss */"./src/assets/styles/index.scss");
